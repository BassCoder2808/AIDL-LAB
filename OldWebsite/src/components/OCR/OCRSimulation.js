...
class App extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="App">
                <Button size="sm" onClick={() => { this.props.history.push('/aboutcourse-ocr') }}
                ...
                <div className="body container">
                    <div style={{ marginTop: "10%" }} className="row">
                               ...
                               server={
                                {  process: (fieldName, file, metadata, load, error, progress, abort) => {
                                       if (!file.type.includes('image')) {
                                           ...
                                           this.setState({ 
                                               message:'Please Upload jpg / png / jpeg file',
                                               isProcessing:false
                                ...
                                labelIdle={'Drag and Drop image (jpg/jpeg/png format) or <span class="filepond--label-action"> Browse </span>'}
                        ...
                        <p className="errormessage" ><b>{this.state.message}</b></p>
